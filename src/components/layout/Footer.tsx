        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/wallets" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Кошельки
                </Link>
              </li>
              <li>
                <Link href="/payments" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Выплаты
                </Link>
              </li>
              <li>
                <Link href="/finances" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Финансы
                </Link>
              </li>
              <li>
                <Link href="/referrals" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Рефералы
                </Link>
              </li>
            </ul>
